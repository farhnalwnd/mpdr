    ...
    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
        <div class="card-body px-4 py-3">
            <div class="row align-items-center">
                <div class="col-9">
                    <h4 class="fw-semibold mb-8">List Approval Pre MPDR</h4>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item">
                                <a class="text-muted text-decoration-none" href="{{ route('dashboard') }}">Home</a>
                            </li>
                            <li class="breadcrumb-item" aria-current="page">List Approval Pre MPDR</li>
                        </ol>
                    </nav>
                </div>
                <div class="col-3">
...
@push('scripts')
    ...
    <script>
        $('#prempdrTable').DataTable({
            ...
            serverSide: false,
            ajax: {
                url: '{{ route('prempdr.approval.list.data') }}',
                type: 'GET',
            ...
            columns: [
                ...
                { data: null, name: 'action', orderable: false, searchable: false, 
                    render: function(data, type, row) {
                        const route = "{{ route('prempdr.approval.form.view', ':formId') }}";

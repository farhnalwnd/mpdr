<x-app-layout>
    ...
    <div class="font-weight-medium shadow-none position-relative overflow-hidden mb-7">
        <div class="card-body px-0">
            <div class="d-flex justify-content-between align-items-center">
                    <h1 class="font-weight-medium mb-0 ml-3">List Departments</h1>
                    <nav aria-label="breadcrumb mr-3">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item text-muted" aria-current="page">Departments</li>
                        </ol>
                    </nav>
            </div>
        </div>
    ...
    <div class="widget-content searchable-container list">
        ...
        <div class="card card-body">
            <div class="table-responsive">
                <table class="table search-table align-middle text-nowrap" id="departmentTable">
                        ...
                        <div class="box">
                            <div class="content">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <select name="dep_head_id" class="form-select form-control">
    ...
    @foreach ($departments as $department)
        <div class="modal fade" id="editDepartmentModal{{ $department->id }}" tabindex="-1" role="dialog"
            aria-labelledby="editDepartmentModalTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-scrollable modal-lg">
                <div class="modal-content">
                    <div class="modal-header modal-colored-header bg-primary text-white">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="add-department-box">
                            <div class="add-department-content">
                                    @csrf
                                    @method('PUT')
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="mb-3 department-name">

<x-app-layout>
    ...
    <div class="font-weight-medium shadow-none position-relative overflow-hidden mb-7">
        <div class="card-body px-0">
            <div class="d-flex justify-content-between align-items-center">
                    <h1 class="font-weight-medium mb-0 ml-3">List Levels</h1>
                    <nav aria-label="breadcrumb mr-3">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item text-muted" aria-current="page">Levels</li>
                        </ol>
                    </nav>
            </div>
        </div>
    ...
    <div class="widget-content searchable-container list">
            <div class="row">
                <div
                    ...
                    <button type="button" class="btn mb-1 bg-primary text-white px-4 fs-4 hover:bg-primary-dark"
                        ...
                        <i class="ti ti-users text-white me-1 fs-5"></i> Add Level
                    </button>
                </div>
            </div>
        ...
        <div class="card card-body">
            <div class="table-responsive">
                <table class="table search-table align-middle text-nowrap" id="levelTable">
    ...
    <!-- Modal Add Level -->
    <div class="modal fade" id="addLevelModal" tabindex="-1" role="dialog" aria-labelledby="addLevelModalTitle"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable modal-lg">
            <div class="modal-content">
                <div class="modal-header modal-colored-header bg-primary text-white">
                    <h5 class="modal-title text-white">Add Level</h5>
    ...
    @foreach ($levels as $level)
        <div class="modal fade" id="editLevelModal{{ $level->id }}" tabindex="-1" role="dialog"
            aria-labelledby="editLevelModalTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-scrollable modal-lg">
                <div class="modal-content">
                    <div class="modal-header modal-colored-header bg-primary text-white">
                        <h5 class="modal-title text-white">Edit Level</h5>
                        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                            aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="add-level-box">
                            <div class="add-level-content">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="mb-3 level-name">
                                                <input type="text" name="name" class="form-control"
                                                    placeholder="Name" value="{{ $level->name }}">
                                                <span class="validation-text text-danger"></span>
                                            </div>
                                        </div>
                                    </div>

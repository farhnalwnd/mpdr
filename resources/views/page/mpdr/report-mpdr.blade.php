    ...
    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4 no-print">
        <div class="card-body px-4 py-3">
            <div class="row align-items-center">
                <div class="col-9">
                    <h4 class="fw-semibold mb-8">Report MPDR</h4>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item">
                                <a class="text-muted text-decoration-none" href="{{ route('dashboard') }}">Home</a>
                            </li>
                            <li class="breadcrumb-item" aria-current="page">Report MPDR</li>
                        </ol>
                    </nav>
                </div>
                <div class="col-3">
        ...
        <script>
            ...
            $('#text-srh1').on('input', function() {
                ...
                forms.forEach((form, index) => {
                    ...
                    if (
                        (form.product_name && form.product_name.toLowerCase().includes(value)) ||

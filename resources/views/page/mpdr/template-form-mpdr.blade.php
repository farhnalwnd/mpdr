    ...
    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
        <div class="card-body px-4 py-3">
            <div class="row align-items-center">
                <div class="col-9">
                    <h4 class="fw-semibold mb-8">Template MPDR</h4>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item">
                                <a class="text-muted text-decoration-none" href="{{ route('dashboard') }}">Home</a>
                            </li>
                            <li class="breadcrumb-item" aria-current="page">Template MPDR</li>
                        </ol>
                    </nav>
                </div>
                <div class="col-3">
        ...
        <main id="prempdr-main" class="d-flex flex-column gap-3 border-top border-4 border-black p-2">
            <div class="row">  
                ...
                <div class="col d-flex justify-content-end">
                    <label for="projectName" class="form-label">No Reg: <span id="no_reg_text">25MPDR0000</span></label>
            ...
            <div id="rational">
                ...
                <div id="rationalForDevelopment">Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequatur eum maiores officiis quo voluptatem deleniti beatae modi optio consequuntur, voluptatum ratione dolore esse neque adipisci reiciendis sed, ipsum distinctio delectus!</div>
            </div>
            <div class="row">
            ...
            <div id="productDescription">
                ...
                <div id="productDescription">Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequatur eum maiores officiis quo voluptatem deleniti beatae modi optio consequuntur, voluptatum ratione dolore esse neque adipisci reiciendis sed, ipsum distinctio delectus!</div>
            </div>
            <div id="usage">
        ...
        <footer id="prempdr-footer" class="p-2 mb-1" style="border-top: 3px solid black ;">
            <table id="approver" class="table table-striped nowrap">
                ...
                <tbody class="">
                    ...
                    <tr>
                        <td id="marketingDeptHead">Dept. Head</td>
                        <td class="text-center"></td>
                        <td class="text-center"></td>
                        <td class="text-center"></td>
                        <td class="text-center"></td>
